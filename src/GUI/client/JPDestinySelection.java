...
public class JPDestinySelection extends JPanel {
	...
	public JPDestinySelection(int width, int height) {
...
//		this.jbAccept.addActionListener(this);
	...
	public void reset() {
		if(this.jtfRoute!= null)
		this.jtfRoute.setText("");
		
		if(this.jtfDestiny!= null)
		this.jtfDestiny.setText("");
		
		this.setVisible(false);
	}


	public JTextField getJtfRoute() {
		return jtfRoute;
	}


	public void setJtfRoute(String jtfRoute) {
		this.jtfRoute.setText(jtfRoute);
	}


	public JTextField getJtfDestiny() {
		return jtfDestiny;
	}


	public void setJtfDestiny(String jtfDestiny) {
		this.jtfDestiny.setText(jtfDestiny);
	}
